				...
				var o = function() {
					...
					return t = e, i = [{
						...
						value: function(e) {
							...
							"_wrs_blackboard" in window && window._wrs_blackboard && (e = (e = (e = e.split(o)
										.join(r.safeGoodBlackboardCharacters.ltElement))
									.split(s)
									.join(r.safeGoodBlackboardCharacters.gtElement))
								.split(l)
								.join(r.safeGoodBlackboardCharacters.ampElement)), t = r.safeXmlCharacters.tagOpener, n = r.safeXmlCharacters.tagCloser, i = r.safeXmlCharacters.doubleQuote, a = r.safeXmlCharacters.realDoubleQuote;
						...
						value: function(e, t) {
							...
							if (0 === i) {
								var r = e.indexOf(">");
								if (-1 === e.indexOf("class")) return n = "".concat(e.substr(i, r), ' class="wrs_')
									.concat(t, '">'), n += e.substr(r + 1, e.length)
							}
							return e
						}
					}, {
						...
						value: function(t, n, i) {
							...
							if (-1 !== t.indexOf("<annotation")) {
								...
								r = "".concat(t.substring(0, a), '<annotation encoding="')
									.concat(i, '">')
									.concat(n, "</annotation>")
								...
								var o = t.indexOf("/>"),
									s = t.indexOf(">"),
									l = s === o ? o : s;
								r = "".concat(t.substring(0, l), '><semantics><annotation encoding="')
									.concat(i, '">')
								...
								var c = t.indexOf(">") + 1,
									...
									u = t.substring(c, d);
								r = "".concat(t.substring(0, c), "<semantics>")
						...
						value: function(e) {
							for (var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : r.xmlCharacters, n = "".concat(t.tagOpener, "math"), i = "".concat(t.tagOpener, "/math")
								.concat(t.tagCloser), a = "/".concat(t.tagCloser), o = t.tagCloser, s = "".concat(t.tagOpener, "semantics")
								.concat(t.tagCloser), l = "".concat(t.tagOpener, "annotation encoding="), c = "", d = e.indexOf(n), u = 0; - 1 !== d;) {
								c += e.substring(u, d);
								var m = e.indexOf(i, d),
									h = e.indexOf(a, d),
						...
						value: function(e) {
							return e.replace(/\w+=".*?"/g, (function(e) {
								var t = e.indexOf('"'),
									...
									i = w.htmlEntities(n);
								return "".concat(e.substring(0, t + 1))
									.concat(i, '"')
							}))
						}
...
// 								.substr(0, window.location.toString()
// 									.lastIndexOf("/") + 1),
							    var n = 'https://www.wiris.net/'
				...
				var f = function() {
					...
					return t = e, i = [{
						...
						value: function(t, n) {
							...
							if ("ok" === s.status) {
								...
								a = -1 === (l = l.split("\r")
										...
										.split("\n")
										.join(" "))
									.indexOf("semantics") && -1 === l.indexOf("annotation") ? l = o.addAnnotation(l, t, "LaTeX") : l, i.get(t) || i.populate(t, l)
							} else a = "$$".concat(t, "$$");
							return a
						}
					}, {
						...
						value: function(t, n) {
							for (var i, a, s, l = "", c = "".concat(n.tagOpener, "math"), d = "".concat(n.tagOpener, "/math")
								.concat(n.tagCloser), u = "".concat(n.tagOpener, "annotation encoding=")
								.concat(n.doubleQuote, "LaTeX")
								.concat(n.doubleQuote)
								.concat(n.tagCloser), m = "".concat(n.tagOpener, "/annotation")
								.concat(n.tagCloser), h = t.indexOf(c), g = 0; - 1 !== h;) {
								if (l += t.substring(g, h), -1 === (g = t.indexOf(d, h)) ? g = t.length - 1 : g += d.length, -1 !== (a = (i = t.substring(h, g))
									.indexOf(u))) {
				...
				var b = function() {
					...
					return t = e, i = [{
						...
						value: function(e) {
							var t = this.language;
							return t && t.length > 2 && (t = t.slice(0, 2)), this.strings.hasOwnProperty(t) || (console.warn("Unknown language ".concat(t, " set in StringManager.")), t = "en"), this.strings[t].hasOwnProperty(e) ? this.strings[t][e] : (console.warn("Unknown key ".concat(e, " for language ")
								.concat(t, " in StringManager.")), e)
						}
					...
					return t = e, i = [{
						...
						value: function(t, n, i, r) {
							n && e.addEvent(t, "dblclick", (function(e) {
								...
								i(n, t)
							})), r && e.addEvent(document, "mouseup", (function(e) {
								var t = e || window.event,
									n = t.srcElement ? t.srcElement : t.target;
								r(n, t)
							}))
						...
						value: function(e) {
							var t = "value=",
								...
								l = s.split("«")
								.join("§lt;");
							return l = (l = (l = l.split("»")
										.join("§gt;"))
									.split("&")
									.join("§"))
								.split("¨")
								.join("§quot;"), e = e.split(s)
								.join(l)
						}
					}, {
						key: "createElement",
						value: function(t, n, i) {
							...
							try {
								...
								r = i.createElement(t), Object.keys(n)
									.forEach((function(e) {
						...
						key: "createObject",
						value: function(t, n) {
							void 0 === n && (n = document), t = (t = (t = (t = t.split("<applet ")
						...
						value: function(t) {
							...
							if (1 === t.nodeType) {
								for (var n = "<".concat(t.tagName), i = 0; i < t.attributes.length; i += 1) t.attributes[i].specified && (n += " ".concat(t.attributes[i].name, '="')
						...
						value: function(e, t) {
							var n = "";
							return e.indexOf("/") !== e.length && 0 !== t.indexOf("/") && (n = "/"), (e + n + t)
								.replace(/([^:]\/)\/+/g, "$1")
						}
					}, {
						key: "htmlEntities",
						...
						value: function() {
							if ("file://" === window.location.toString()
								.substr(0, window.location.toString()
									.lastIndexOf("/") + 1)
								.substr(0, 7)) throw b.get("exception_cross_site");
						...
						value: function(t) {
							...
							return Object.keys(t)
								.forEach((function(i) {
									null != t[i] && (n += "".concat(e.urlEncode(i), "=")
						...
						value: function(t, n, i) {
							var r;
							if (n ? (r = t.contentWindow)
								.focus() : (r = window, t.focus()), document.selection && !i) {
								...
								if (a.parentElement) {
									...
									return "IMG" !== l.nodeName.toUpperCase() && (a.pasteHTML('<span id="wrs_openEditorWindow_temporalObject"></span>'), l = r.document.getElementById("wrs_openEditorWindow_temporalObject")), l.nextSibling && 3 === l.nextSibling.nodeType ? (o = l.nextSibling, s = 0) : l.previousSibling && 3 === l.previousSibling.nodeType ? s = (o = l.previousSibling)
										.nodeValue.length : (o = r.document.createTextNode(""), l.parentNode.insertBefore(o, l), s = 0), l.parentNode.removeChild(l), {
											node: o,
											caretPosition: s
										}
								}
						...
						value: function(e, t) {
							if (e && t)
								...
								} else document.selection.createRange()
									.text = t
						}
					}, {
						...
						value: function(e, t, n) {
							var i;
							return i = e.indexOf("?") > 0 ? "&" : "?", "".concat(e + i + t, "=")
								.concat(n)
						}
					...
					return t = e, i = [{
						...
						value: function(t, n, i, r) {
							...
							if (s.mml = n, s.lang = r, s.metrics = "true", s.centerbaseline = "false", "base64" === l.get("saveMode") && "default" === l.get("base64savemode") && (s.base64 = !0), a.className = l.get("imageClassName"), -1 !== n.indexOf('class="')) {
								...
								c = (c = c.substring(0, c.indexOf('"')))
									.substring(4, c.length), a.setAttribute(l.get("imageCustomEditorName"), c)
							}
							if (!l.get("wirisPluginPerformance") || "xml" !== l.get("saveMode") && "safeXml" !== l.get("saveMode")) {
								...
								"png" === (u = u.result)
								.format ? a.src = "data:image/png;base64,".concat(u.content) : a.src = "data:image/svg+xml;charset=utf8,".concat(w.urlEncode(u.content)), a.setAttribute(l.get("imageMathmlAttribute"), o.safeXmlEncode(n)), k.setImgSize(a, u.content, !0), l.get("enableAccessibility") && (void 0 === u.alt ? a.alt = C.mathMLToAccessible(n, r, s) : a.alt = u.alt)
							}
						...
						value: function(e, t) {
							...
							if (-1 !== n.indexOf("@BASE@")) {
								var i = g.getServicePath("createimage")
									.split("/");
								i.pop(), n = n.split("@BASE@")
									.join(i.join("/"))
							}
							return n
						}
						...
						value: function(t, n, i) {
							for (var a = "", s = "".concat(n.tagOpener, "math"), c = "".concat(n.tagOpener, "/math")
								.concat(n.tagCloser), d = t.indexOf(s), u = 0; - 1 !== d;) {
								a += t.substring(u, d);
				...
				var O = function() {
					...
					return t = e, i = [{
						...
						value: function() {
							if (e.isEditorLoaded()) {
								if (this.editor = window.com.wiris.jsEditor.JsEditor.newInstance(this.editorAttributes), this.editor.insertInto(this.modalDialogInstance.contentContainer), this.editor.focus(), this.modalDialogInstance.rtl && this.editor.action("rtl"), this.editor.getEditorModel()
									.isRTL() && (this.editor.element.style.direction = "rtl"), this.editor.getEditorModel()
									.addEditorListener(this.editorListener), this.modalDialogInstance.deviceProperties.isIOS) {
									setTimeout((function() {
						...
						value: function() {
							...
							t.src = "".concat(n, "?lang=")
								...
								.concat(r.version), document.getElementsByTagName("head")[0].appendChild(t)
						}
					}, {
						key: "getEditorStats",
						value: function() {
						...
						value: function() {
							if (this.editor.isFormulaEmpty()) this.integrationModel.updateFormula(null);
								...
								if (null !== this.customEditors.getActiveEditor()) {
									var t = this.customEditors.getActiveEditor()
										.toolbar;
									e = o.addCustomEditorClassAttribute(e, t)
								} else Object.keys(this.customEditors.editors)
									.forEach((function(t) {
						...
						key: "setEmptyMathML",
						value: function() {
							this.deviceProperties.isAndroid || this.deviceProperties.isIOS ? this.editor.getEditorModel()
								.isRTL() ? this.setMathML('<math dir="rtl"><semantics><annotation encoding="application/json">[]</annotation></semantics></math>', !0) : this.setMathML('<math><semantics><annotation encoding="application/json">[]</annotation></semantics></math>', !0) : this.editor.getEditorModel()
								.isRTL() ? this.setMathML('<math dir="rtl"/>', !0) : this.setMathML("<math/>", !0)
						}
					}, {
						key: "onOpen",
						value: function() {
						...
						value: function(e) {
							if (void 0 !== e.key && !1 === e.repeat)
								if ("Escape" === e.key || "Esc" === e.key) {
									...
									0 === t.length && 0 === (t = document.getElementsByClassName("wrs_expandButton wrs_expandButtonFor2RowsLayout wrs_pressed"))
										.length && 0 === (t = document.getElementsByClassName("wrs_select wrs_pressed"))
										.length && (this.modalDialogInstance.cancelAction(), e.stopPropagation(), e.preventDefault())
							...
							else "Tab" === e.key && (document.activeElement === this.modalDialogInstance.cancelButton ? (document.querySelector('[title="Manual"]')
								.focus(), e.stopPropagation(), e.preventDefault()) : "wrs_formulaDisplay wrs_focused" === document.getElementsByClassName("wrs_formulaDisplay")[0].getAttribute("class") && (this.modalDialogInstance.submitButton.focus(), e.stopPropagation(), e.preventDefault()))
						}
				...
				var R, U = function() {
						...
						return t = e, (n = [{
							...
							value: function(e, t) {
								var n = {};
								return (n = document.createElement("button"))
									.setAttribute("id", e.id), n.setAttribute("class", e.class), n.innerHTML = e.innerHTML, n.addEventListener("click", t), n
							}
						}, {
							key: "show",
							value: function() {
				...
				for (var J = [], K = 0; K < 256; ++K) J.push((K + 256)
					.toString(16)
					.substr(1));
				const Q = function(e) {
					var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
						n = (J[e[t + 0]] + J[e[t + 1]] + J[e[t + 2]] + J[e[t + 3]] + "-" + J[e[t + 4]] + J[e[t + 5]] + "-" + J[e[t + 6]] + J[e[t + 7]] + "-" + J[e[t + 8]] + J[e[t + 9]] + "-" + J[e[t + 10]] + J[e[t + 11]] + J[e[t + 12]] + J[e[t + 13]] + J[e[t + 14]] + J[e[t + 15]])
						.toLowerCase();
				...
				function q(e, t) {
					return function(e) {
						...
						var i, r, a = [],
							...
							s = !1;
						try {
							for (n = n.call(e); !(o = (i = n.next())
								.done) && (a.push(i.value), !t || a.length !== t); o = !0);
						} catch (e) {
							s = !0, r = e
						} finally {
							try {
				...
				var ee = function() {
						...
						return t = e, i = [{
							...
							get: function() {
								if (!this._senderId) {
									...
									this._senderId || (this._senderId = e.composeUUID(), document.cookie = this.composeCookie(te, this._senderId, ne))
								}
							...
							get: function() {
								var e = WirisPlugin.currentInstance.environment.editor,
									t = "";
								return /Generic/.test(e) ? t = "generic" : /Froala/.test(e) ? t = "froala" : /CKEditor/.test(e) ? t = "ckeditor" : /TinyMCE/.test(e) && (t = "tinymce"), "".concat("mathtype-web-plugin-")
									.concat(t)
							}
						}, {
							key: "composeBody",
					...
					te = "wiris_telemetry_mathtype_web_senderid",
					ne = 31536e4;
				...
				ee.endpoint = "https://telemetry.wiris.net", ee._senderId = "", ee._sessionId = "";
				var re = function() {
					function e(t) {
						var n = this;
						if (function(e, t) {
					...
					return t = e, i = [{
						...
						value: function() {
							...
							var s = {};
							s.serviceProviderProperties = this.serviceProviderProperties, this.setCore(new _e(s)), this.core.addListener(t), this.core.language = this.language, this.core.init(), this.core.setEnvironment(this.environment)
						}
					}, {
						key: "getPath",
						value: function() {
				...
				var de = function() {
					function e(t) {
						...
						var o = window.outerWidth,
							...
							m = d || u;
						this.instanceId = document.getElementsByClassName("wrs_modal_dialogContainer")
							.length, this.deviceProperties = {
						...
						h.id = this.getElementId(h.class), this.overlay = w.createElement("div", h), (h = {})
							.class = "wrs_modal_title_bar", h.id = this.getElementId(h.class), this.titleBar = w.createElement("div", h), (h = {})
							.class = "wrs_modal_title", h.id = this.getElementId(h.class), this.title = w.createElement("div", h), this.title.innerHTML = "", (h = {})
							.class = "wrs_modal_close_button", h.id = this.getElementId(h.class), h.title = b.get("close"), h.style = {}, this.closeDiv = w.createElement("a", h), this.closeDiv.setAttribute("role", "button");
					...
					return ce(e, [{
						...
						value: function(e, t) {
							return new(function() {
									function n() {
										se(this, n), this.element = document.createElement("button"), this.element.id = e.id, this.element.className = e.class, this.element.innerHTML = e.innerHTML, w.addEvent(this.element, "click", t)
									}
									return ce(n, [{
										key: "getElement",
										value: function() {
						...
						value: function(e, t) {
							w.addClass(document.body, "wrs_noselect"), w.addClass(this.overlay, "wrs_overlay_active"), this.resizeDataObject = {
								x: this.eventClient(e)
									.X,
								y: this.eventClient(e)
									.Y
						...
						key: "close",
						value: function() {
							re.setTemporalImageToNull(), this.removeClass("wrs_maximized"), this.removeClass("wrs_minimized"), this.removeClass("wrs_stack"), this.addClass("wrs_closed"), this.saveModalProperties(), this.unlockWebsiteScroll(), this.properties.open = !1
						}
					}, {
						...
						value: function() {
							...
							var e = "background-size: 10px; background-repeat: no-repeat; background-image: url(data:image/svg+xml;base64,".concat(window.btoa(ae), ")"),
								t = "background-size: 10px; background-repeat: no-repeat; background-image: url(data:image/svg+xml;base64,".concat(window.btoa(oe), ")");
						...
						value: function(e) {
							if (this.dragDataObject) {
								e.preventDefault();
								var t = Math.min(this.eventClient(e)
									.Y, this.limitWindow.minPointer.y);
								t = Math.max(this.limitWindow.maxPointer.y, t);
								var n = Math.min(this.eventClient(e)
									.X, this.limitWindow.minPointer.x);
								...
								this.lastDrag = {
										x: i,
										y: r
									}, this.container.style.transform = "translate3d(".concat(i, ",")
									.concat(r, ",0)")
							}
							if (this.resizeDataObject) {
								var a, o = window.innerWidth,
									s = window.innerHeight,
									l = Math.min(this.eventClient(e)
										.X, o - this.scrollbarWidth - 7),
									c = Math.min(this.eventClient(e)
										.Y, s - 7);
				...
				var ue;
				String.prototype.codePointAt || (ue = function(e) {
					...
					configurable: !0,
					writable: !0
				}) : String.prototype.codePointAt = ue), "function" != typeof Object.assign && Object.defineProperty(Object, "assign", {
					value: function(e, t) {
				...
				var _e = function() {
					...
					return t = e, i = [{
						...
						value: function(t, n) {
							var i = new D;
							return i.mathml = t, i.wirisProperties = {}, null != n && Object.keys(n)
								.forEach((function(e) {
						...
						value: function(e, t, n) {
							if (this.editionProperties.isNewElement)
								...
								var s = o.startContainer,
									l = o.startOffset;
								3 === s.nodeType ? (s = s.splitText(l))
									.parentNode.insertBefore(e, s) : 1 === s.nodeType && s.insertBefore(e, s.childNodes[l]), this.placeCaretAfterNode(e)
						...
						value: function(e, t) {
							...
							for (var p = l.get("editorAttributes")
								.split(", "), _ = {}, v = 0, b = p.length; v < b; v += 1) {
								var y = p[v].split("="),
									x = y[0],
									k = y[1];
								_[x] = k
							...
							if (T.editorAttributes = A, T.language = this.language, T.customEditors = this.customEditors, T.environment = this.environment, null == this.modalDialog) {
								this.modalDialog = new de(A), this.contentManager = new O(T);
					...
					}]) && fe(t.prototype, n), i && fe(t, i), e
				}();
				_e._globalListeners = new m, _e._initialized = !1;
				const ve = "7.26.1";
				...
				var Me = function(e) {
					...
					function a(e) {
						...
						return function(e, t) {
								if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
							}(this, a), (t = r.call(this, e))
							.initParsed = e.initParsed, t.isMoodle = e.isMoodle, t.isExternal = e.isExternal, t
					}
					return t = a, (n = [{
						key: "getPath",
						value: function() {
							if (this.isMoodle) {
								...
								return tinymce.baseURL.substr(0, t + e.length) + "/plugins/tiny_mce_wiris/tinymce/"
							}
							if (this.isExternal) {
								var n = this.editorObject.getParam("external_plugins")
									.tiny_mce_wiris;
						...
						value: function() {
							...
							if (e.wirisformulaeditorlang) return console.warn("Deprecated property wirisformulaeditorlang. Use mathTypeParameters on instead."), e.wirisformulaeditorlang;
							var t = this.editorObject.getParam("language");
							return t || we(Ce(a.prototype), "getLanguage", this)
								.call(this)
						}
					}, {
						key: "callbackFunction",
						value: function() {
							var e = this,
								t = [];
							we(Ce(a.prototype), "callbackFunction", this)
								.call(this);
							...
							this.getCore()
								.addListener(i), t[this.editorObject.id] = this.editorObject.settings.images_dataimg_filter, this.editorObject.settings.images_dataimg_filter = function(n) {
									return n.hasAttribute("class") && -1 != n.getAttribute("class")
										.indexOf(l.get("imageClassName")) ? n.hasAttribute("internal-blob") : void 0 === t[e.editorObject.id] || t[e.editorObject.id](n)
								}
						}
					}, {
						key: "updateFormula",
						value: function(e) {
							void 0 !== this.editorObject.fire && this.editorObject.fire("ExecCommand", {
									...
									value: e
								}), we(Ce(a.prototype), "updateFormula", this)
								.call(this, e)
						}
					}]) && ye(t.prototype, n), i && ye(t, i), a
				}(re);
				tinymce.create("tinymce.plugins.tiny_mce_wiris", {
					init: function(e, t) {
						...
						n.serviceProviderProperties.URI = "https://www.wiris.net/demo/plugins/app", n.serviceProviderProperties.server = "java", n.version = ve, n.isMoodle = "object" === ("undefined" == typeof M ? "undefined" : be(M)) && null !== M, void 0 !== e.getParam("wiriscontextpath") && (n.configurationService = w.concatenateUrl(e.getParam("wiriscontextpath"), n.configurationService), e.getParam("wiriscontextpath"), n.configurationService, console.warn("Deprecated property wiriscontextpath. Use mathTypeParameters on instead.", e.opts.wiriscontextpath)), void 0 !== e.getParam("mathTypeParameters") && (n.integrationParameters = e.getParam("mathTypeParameters")), n.scriptName = "plugin.min.js", n.environment = {};
						var i = "4";
						"5" === tinymce.majorVersion && (i = "5"), n.environment.editor = "TinyMCE " + i + ".x", n.environment.editorVersion = tinymce.majorVersion + "." + tinymce.minorVersion, n.callbackMethodArguments = {}, n.editorObject = e, n.initParsed = !1, n.target = null;
						var r = void 0 !== e.getParam("external_plugins") && "tiny_mce_wiris" in e.getParam("external_plugins");
						n.isExternal = r, n.rtl = "rtl" === e.getParam("directionality");
						var a = new Me(n);
						a.init(), WirisPlugin.instances[a.editorObject.id] = a, WirisPlugin.currentInstance = a;
						var o = function(e) {
							var t = WirisPlugin.instances[a.editorObject.id];
							e.inline ? t.setTarget(e.getElement()) : t.setTarget(e.getContentAreaContainer()
									.firstChild), t.setEditorObject(e), t.listeners.fire("onTargetReady", {}), "wiriseditorparameters" in e.settings && l.update("editorParameters", e.settings.wiriseditorparameters), new MutationObserver(function(e, t) {
						...
						"onInit" in e ? e.onInit.add(o) : e.on("init", (function() {
							o(e)
						...
						function d() {
							...
							t.core.getCustomEditors()
								.disable(), t.openNewFormulaEditor()
						}
						"onSaveContent" in e ? e.onSaveContent.add(c) : e.on("saveContent", (function(t) {
							c(e, t)
						...
						if ("5" === tinymce.majorVersion) {
							...
							.addCommand("tiny_mce_wiris_openFormulaEditor", d);
						...
						var g = WirisPlugin.instances[e.id].getCore()
							.getCustomEditors();
						for (var p in g.editors)
							if (g.editors[p].confVariable) {
								var f = function() {
										g.enable(p), WirisPlugin.instances[e.id].openNewFormulaEditor()
									},
									_ = "tiny_mce_wiris_openFormulaEditor" + g.editors[p].name;
								e.addCommand(_, f), s.addButton("tiny_mce_wiris_formulaEditor" + g.editors[p].name, {
									title: g.editors[p].tooltip,
									tooltip: g.editors[p].tooltip,
									onAction: f,
									cmd: _,
									image: WirisPlugin.instances[e.id].getIconsPath() + g.editors[p].icon,
									icon: m
								})
							}
					},
				...
				var Ee = function() {
					...
					return t = e, i = [{
						...
						value: function() {
							var e;
							console.log("Testing configuration service..."), console.log(g.getService("configurationjs", "", "get")), console.log("Testing showimage service..."), (e = [])
								.mml = '<math xmlns="http://www.w3.org/1998/Math/MathML"><msup><mi>x</mi><mn>2</mn></msup></math>', console.log(g.getService("showimage", e)), console.log("Testing createimage service..."), (e = [])
								.mml = '<math xmlns="http://www.w3.org/1998/Math/MathML"><msup><mi>x</mi><mn>2</mn></msup></math>', console.log(g.getService("createimage", e, "post")), console.log("Testing MathML2Latex service..."), (e = [])
								.service = "mathml2latex", e.mml = '<math xmlns="http://www.w3.org/1998/Math/MathML"><msup><mi>x</mi><mn>2</mn></msup></math>', console.log(g.getService("service", e)), console.log("Testing Latex2MathML service..."), (e = [])
								.service = "latex2mathml", e.latex = "x^2", console.log(g.getService("service", e)), console.log("Testing Mathml2Accesible service..."), (e = [])
								.service = "mathml2accessible", e.mml = '<math xmlns="http://www.w3.org/1998/Math/MathML"><msup><mi>x</mi><mn>2</mn></msup></math>', console.log(g.getService("service", e))
						}
					}], (n = null) && Te(t.prototype, n), i && Te(t, i), e
				}();
				window.WirisPlugin = {
					Core: _e,
					Parser: E,
				...
				e.exports = function(e) {
					...
					return t.toString = function() {
						...
						for (var s = 0; s < e.length; s++) {
							var l = [].concat(e[s]);
							i && r[l[0]] || (n && (l[2] ? l[2] = "".concat(n, " and ")
								.concat(l[2]) : l[2] = n), t.push(l))
						}
					}, t
				}
			},
			379: (e, t, n) => {
				...
				var d, u = (d = [], function(e, t) {
					return d[e] = t, d.filter(Boolean)
						.join("\n")
				});

				function m(e, t, n, i) {
					var r = n ? "" : i.media ? "@media ".concat(i.media, " {")
						.concat(i.css, "}") : i.css;
				...
				e.exports = function(e, t) {
					(t = t || {})
					.singleton || "boolean" == typeof t.singleton || (t.singleton = r());
					var n = l(e = e || [], t);
					return function(e) {
